...
/**
 * cliente web service de funcionalidade.
 * 
 * @author SEDSC/COSIS/STI - TRE/CE
 */
@RequestScoped
public class FuncionalidadeClient {

	/**
	 * lista descrição de funcionalidade.
	 * 
	 * @param sistema
	 * @param perfil
	 * @return lista de descrição de funcionalidade
	 */
	public List<String> listarDescricao(Long sistema, String perfil) {

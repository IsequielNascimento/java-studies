...
public class PerfilClient {
	...
	/**
	 * lista descrição de perfil.
	 * 
	 * @param sistema
	 * @param matricula
	 * @return lista de descrição de perfil
	 */
	public List<String> listarDescricao(Long sistema, String matricula) {
